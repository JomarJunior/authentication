...
class TestEventDispatcher:
    ...
    def test_append_subscriber_adds_to_existing_list(self):
        ...
        dispatcher.AppendSubscriber(event_class, new_subscriber)
    ...
    def test_append_subscriber_raises_keyerror_for_unknown_event(self):
        ...
        with pytest.raises(KeyError):
            dispatcher.AppendSubscriber(event_class, mock_subscriber)
...
class TestEventEmitter:
    ...
    def test_release_events_returns_all_events(self):
        ...
        released_events = emitter.ReleaseEvents()
    ...
    def test_release_events_multiple_calls(self):
        ...
        emitter.EmitEvent(event1)
        first_release = emitter.ReleaseEvents()

        emitter.EmitEvent(event2)
        second_release = emitter.ReleaseEvents()
